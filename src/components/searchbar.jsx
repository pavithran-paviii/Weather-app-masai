...
export const Searchbar = ({setWeatherDetails,weatherDetails}) => {
  ...
  return (
    <div id="searchbarDiv">
      ...
      <input placeholder='Enter your city here' className='searchBox' onChange={(e)=>setCity(e.target.value)} onKeyPress={(e) => {
                        if (e.key === "Enter") {
                          searchDetails()
                        }
                    }}/>
      <img alt="search" src={search} id="locationSearch" onClick={searchDetails}/>
    </div>
  )
}
